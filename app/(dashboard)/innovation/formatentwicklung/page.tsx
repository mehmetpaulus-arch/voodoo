...
export default function FormatentwicklungPage() {
  ...
  const formats = [
    {
      ...
      description: 'Neues Format für partizipative Dokumentationen mit Echtzeit-Feedback und KI-gestützter Personalisierung',
      ...
      created: '2024-06-15',
      tags: ['Interaktiv', 'KI', 'Dokumentation'],
      aiScore: 89,
      targetAudience: '18-45 Jahre',
      duration: '45-60 Min',
      platforms: ['TV', 'Online', 'Mobile']
    },
    {
      id: 'FORMAT-002',
      title: 'KI-Newsroom',
      description: 'Automatisierte Nachrichtenproduktion mit KI-gestützter Recherche und Personalisierung',
      ...
      aiScore: 92,
      targetAudience: '25-55 Jahre',
      duration: '15-30 Min',
      platforms: ['Online', 'Mobile', 'Smart TV']
    },
    {
      id: 'FORMAT-003',
      title: 'Virtual Reality Talkshow',
      description: 'Immersive Talkshow-Erfahrung in virtuellen Räumen mit KI-Moderator',
      ...
      author: 'Anna Schmidt',
      created: '2024-06-13',
      tags: ['VR', 'KI', 'Entertainment'],
      aiScore: 76,
      targetAudience: '18-35 Jahre',
      duration: '30-45 Min',
      platforms: ['VR', 'Online']
    }
  ];
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                <h2 className="text-3xl font-bold text-gray-900">KI-Formatentwicklung</h2>
                <Badge className="bg-[#E37222] text-white">ZDF Innovation Lab</Badge>
              </div>
              <p className="text-lg text-gray-700 mb-6">
                Entwickle revolutionäre TV- und Online-Formate mit KI-Unterstützung. 
                Unser System analysiert Zielgruppen, optimiert Inhalte und testet neue Konzepte automatisch.
              </p>
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-2">
                  <Brain className="w-5 h-5 text-[#E37222]" />
                  <span className="text-gray-700 font-medium">KI-Content-Optimierung</span>
                </div>
                <div className="flex items-center gap-2">
                  <Target className="w-5 h-5 text-[#E37222]" />
                  <span className="text-gray-700 font-medium">Zielgruppen-Analyse</span>
                </div>
                <div className="flex items-center gap-2">
        ...
        <div className="bg-gradient-to-r from-[#E37222] to-[#F97316] rounded-lg p-6 mb-8 text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold">KI-Format-Assistent aktiv</h3>
                <p className="text-white/90">Analysiert Zielgruppen und optimiert Format-Konzepte in Echtzeit</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-gray-300">
              ...
              <CardContent className="space-y-4">
                <div className="flex gap-4">
                  <Input
                    placeholder="Formate durchsuchen..."
                    value={searchTerm}
            ...
            <div className="space-y-4">
              {formats.map((format) => (
                <Card key={format.id} className="border-gray-300 hover:shadow-lg transition-shadow">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <Badge 
                            className={`text-xs ${
                              format.priority === 'Hoch' ? 'bg-red-100 text-red-800' :
                              format.priority === 'Mittel' ? 'bg-yellow-100 text-yellow-800' :
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-4 text-sm">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-600">{format.targetAudience}</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Clock className="w-4 h-4 text-gray-400" />
                            <span className="text-gray-600">{format.duration}</span>
                          </div>
                          <div className="flex items-center gap-2">
                            <Monitor className="w-4 h-4 text-gray-400" />
                            <span className="text-gray-600">{format.platforms.join(', ')}</span>
                          </div>
                        </div>
                    ...
                    {aiEnabled && (
                      <div className="bg-gray-50 rounded-lg p-4 mb-4">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="font-medium text-gray-900">KI-Format-Analyse</span>
                          <Badge className="bg-[#E37222] text-white text-xs">
                            Score: {format.aiScore}/100
                          </Badge>
                        </div>
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            <span>Marktpotential</span>
                            <span className="font-medium">{format.aiScore}%</span>
                          </div>
                          <Progress value={format.aiScore} className="h-2" />
                          <p className="text-sm text-gray-600">
                            Hohe Zielgruppen-Affinität erkannt. Empfohlene Plattformen: {format.platforms.join(', ')}.
                          </p>
                        </div>
                      </div>
                    )}
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600">5 neue Trend-Formate</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    <span className="text-sm text-gray-600">Zielgruppen-Update</span>
                  </div>
                  <div className="flex items-center gap-2">
            ...
            <Card className="border-gray-300">
              <CardHeader>
                <CardTitle className="text-gray-900">Format-Statistiken</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Aktive Formate</span>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-[#E37222]">86%</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-300">
              <CardHeader>
                <CardTitle className="text-gray-900">Plattform-Verteilung</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
