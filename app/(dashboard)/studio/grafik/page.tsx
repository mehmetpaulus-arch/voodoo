...
const grafikPanels = [
  {
    id: 'new-project',
    title: 'Neues Grafik-Projekt (AI)',
    subtitle: 'Design-Assistent',
    icon: Palette,
    color: 'bg-gray-400'
  },
  {
    ...
    subtitle: 'Text zu Bild (Diffusion/DALL·E)',
    icon: Wand2,
    color: 'bg-gray-400',
    href: '/studio/grafik/image-generator'
  },
  {
    id: 'image-editing',
  ...
  },
  {
    ...
    subtitle: 'Stile übertragen / Corporate',
    icon: Sparkles,
    color: 'bg-[#E37222]'
  },
  {
  ...
  {
    id: 'export',
    title: 'Export Variationen',
    subtitle: 'Formate für Social/Print/Web',
    icon: Download,
    color: 'bg-gray-400'
  },
  {
    id: 'team',
    title: 'Grafik Team',
    subtitle: 'Kollaboration & Workflows',
    icon: Users,
    color: 'bg-gray-400'
  },
];
