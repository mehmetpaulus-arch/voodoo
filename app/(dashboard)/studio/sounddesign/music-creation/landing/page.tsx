...
export default function MusicCreationLandingPage() {
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                <h2 className="text-3xl font-bold text-gray-900">Music Creation</h2>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              {musicProjects.map((project) => (
                <Card key={project.id} className="border-gray-300 hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          <h3 className="text-lg font-semibold text-gray-900">{project.title}</h3>
                          {project.isNew && <Badge className="bg-green-100 text-green-800">Neu</Badge>}
                          {project.isFeatured && <Badge className="bg-[#E37222] text-white">Featured</Badge>}
                          <Badge variant="outline" className="text-xs">
                            {project.genre}
                          </Badge>
                          <Badge className={`text-xs ${getMoodColor(project.mood)}`}>
                            {project.mood}
                          </Badge>
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-600">{project.bpm} BPM</span>
                          </div>
                          <div className="flex items-center gap-2">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-600">{project.lastModified}</span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-6 text-sm text-gray-500 mb-4">
                          <div className="flex items-center gap-1">
                            ...
                            {project.popularity}% Popularität
                          </div>
                          <div className="flex items-center gap-1">
