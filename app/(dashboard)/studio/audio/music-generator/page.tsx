  ...
  const musicTracks = [
    {
      ...
      isNew: true,
      isFeatured: true,
      waveform: [0.2, 0.8, 0.4, 0.9, 0.3, 0.7, 0.5, 0.6, 0.8, 0.4]
    },
    {
      id: 'TRACK-002',
      ...
      isNew: false,
      isFeatured: false,
      waveform: [0.3, 0.6, 0.9, 0.4, 0.7, 0.8, 0.5, 0.3, 0.6, 0.9]
    },
    {
      id: 'TRACK-003',
      ...
      isNew: false,
      isFeatured: true,
      waveform: [0.1, 0.3, 0.2, 0.4, 0.3, 0.2, 0.4, 0.3, 0.2, 0.3]
    }
  ];
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-gray-300">
              <CardHeader>
                ...
                <CardDescription>
                  Erstellen Sie maßgeschneiderte Musik mit KI-Unterstützung
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea 
                    placeholder="Beschreiben Sie den gewünschten Musikstil..."
                    rows={3}
                  />
                </div>
            ...
            <Card className="border-gray-300">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-gray-900">
                  <Music className="w-5 h-5 text-[#E37222]" />
                  Generierte Tracks
                </CardTitle>
              </CardHeader>
              <CardContent>
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-sm text-gray-500 ml-2">{track.duration}</span>
                          </div>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-600">Generierte Tracks</span>
