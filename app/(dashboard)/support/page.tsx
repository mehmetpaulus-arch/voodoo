...
const supportPanels = [
  {
    id: 'hilfe-center',
    title: 'Hilfe-Center',
    subtitle: 'FAQ und Dokumentation',
    icon: HelpCircle,
    color: 'bg-[#F2F2F2]',
    href: '/support/hilfe-center'
  },
  {
    id: 'ticket',
    title: 'Ticket erstellen',
    subtitle: 'Support-Anfrage stellen',
    icon: MessageCircle,
    color: 'bg-[#E37222]',
    href: '/support/ticket'
  },
  {
    id: 'onboarding',
    title: 'Onboarding & Schulungen',
    subtitle: 'Einführung und Weiterbildung',
    icon: BookOpen,
    color: 'bg-[#F2F2F2]',
  ...
  },
  {
    id: 'live-chat',
    title: 'Live Chat',
    subtitle: 'Direkter Support-Chat',
    icon: MessageCircle,
    color: 'bg-[#E37222]'
  },
  {
  ...
  },
  {
    ...
    subtitle: 'Schriftliche Anfragen',
    icon: Mail,
    color: 'bg-[#E37222]'
  },
  {
  ...
  },
  {
    ...
    subtitle: 'API-Docs und Entwickler-Ressourcen',
    icon: FileText,
    color: 'bg-[#F2F2F2]'
  }
];
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ 
      ...
      <div className="flex-1 p-8">
        <PanelGrid
          panels={supportPanels}
          title="Support"
          subtitle="Hilfe, Schulungen und technischer Support"
        />
      </div>
    </div>
  );
