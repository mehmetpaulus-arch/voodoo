...
const businessDevelopmentPanels = [
  {
    id: 'market-analysis',
    title: 'Marktanalyse',
    subtitle: 'Markttrends und Chancen identifizieren',
    icon: BarChart3,
    color: 'bg-gray-400'
  },
  {
    ...
    subtitle: 'Geschäftsstrategien entwickeln',
    icon: Target,
    color: 'bg-gray-400'
  },
  {
    ...
    subtitle: 'Strategische Allianzen aufbauen',
    icon: Handshake,
    color: 'bg-[#E37222]'
  },
  {
    ...
    subtitle: 'Einnahmequellen diversifizieren',
    icon: TrendingUp,
    color: 'bg-[#E37222]'
  },
  {
    ...
    subtitle: 'Neue Geschäftsmodelle entwickeln',
    icon: Lightbulb,
    color: 'bg-gray-400'
  },
  {
    ...
    subtitle: 'Märkte global erschließen',
    icon: Globe,
    color: 'bg-[#E37222]'
  }
];
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#e5e7eb' }}>
      ...
      <div className="flex-1 p-4 sm:p-6 md:p-8">
        <PanelGrid
          panels={businessDevelopmentPanels}
          title="Business Development"
          subtitle="Marktchancen erkennen, Strategien entwickeln und Wachstum vorantreiben"
        />
      </div>
    </div>
  );
